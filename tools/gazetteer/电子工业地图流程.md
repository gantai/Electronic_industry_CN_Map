...
```mermaid
flowchart TD
    A["某某志 第N篇.md"] -->|挪进 转换稿| B["D:\Coding\CN_Map\转换稿"]
    B -->|gaz volume| C["待核工作簿<br/>五张表"]
    C -->|你核对:改字、填别名、写 y| D["核过的工作簿"]
    D -->|gaz xlsx --from| E["CN_Electronic_Industry.xlsx"]
    E -->|gaz verify / dups| E
    E -->|gaz geocode<br/>有厂址的章才做| F["src/geocode.js 的 PLACES"]
    E -->|npm run dev| G["本地看图"]
    E -->|合进 main| H["GitHub Pages<br/>线上那张图"]
    E -->|gaz push| I["Obsidian 库<br/>一单位一则笔记"]
    I -->|gaz pull| E
```
