...
**二、逐年名称。** `Founder` 链条里带日期的步骤,凡写明改名、改称或直接给出新名的,排成一条名称时间线;划归、并入一类的机构变动不当作改名,名字顺延,末一次变动之后回落到表内 A 列的名称。地图与提示框因此按年份显示当年的名号 —— 冶金所在 1930 年标作「中央研究院工学研究所」,1975 年的电子光学所标作「上海新跃仪表厂」。详情页的「名称沿革」列出全部区间并标出当前年份所在的一段。
